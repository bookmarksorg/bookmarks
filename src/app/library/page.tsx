                ...
                <div className="flex flex-col flex-grow p-8 pl-12 gap-8 bg-[#C4CCD8] overflow-y-auto">
                    ...
                    <div className="flex flex-col bg-white text-gray-600 pt-6 pb-12 w-full rounded-lg px-8 justify-center">
                        ...
                        <div className="grid grid-cols-5 gap-12 mt-4">
                            <Book image="https://m.media-amazon.com/images/I/91k68MKPbNL._AC_UF1000,1000_QL80_.jpg" title="Oyasumi Punpun" author="Inio Asano" rating="5.0 (1.231)" />
                            <Book
                            ...
                            <Book
                                ...
                                rating="3.4 (3.288)"
                            />
                            <Book image="https://m.media-amazon.com/images/I/614SwlZNtJL._AC_UF1000,1000_QL80_.jpg" title="The Hunger Games" author="Suzanne Collins" rating="5.0 (923)" />
                        </div>
                    </div>
