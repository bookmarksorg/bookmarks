        ...
        <div className="flex flex-col flex-grow p-8 pl-12 gap-8 bg-[#C4CCD8] dark:bg-[#1C2635] dark:text-white overflow-y-auto">
            ...
            <div className="flex flex-col bg-white dark:bg-[#253449] text-gray-600 dark:text-white/90 pt-8 pb-12 w-full rounded-lg px-8 justify-center">
                ...
                <div className="grid grid-cols-5 gap-12 mt-4">
                    <Book id="z7b8w0fkh0" image="https://m.media-amazon.com/images/I/91k68MKPbNL._AC_UF1000,1000_QL80_.jpg" title="Oyasumi Punpun" author="Inio Asano" rating="5.0 (666.666) " />
                    <Book
                        id="m53ynos09g"
                    ...
                    <Book
                        ...
                        rating="3.4 (3.288)"
                    />
                    <Book id="c3x5jiogs9" image="https://m.media-amazon.com/images/I/614SwlZNtJL._AC_UF1000,1000_QL80_.jpg" title="The Hunger Games" author="Suzanne Collins" rating="5.0 (923)" />
                    <Book id="z7b8w0fkh0" image="https://m.media-amazon.com/images/I/91k68MKPbNL._AC_UF1000,1000_QL80_.jpg" title="Oyasumi Punpun" author="Inio Asano" rating="5.0 (666.666) " />
                    <Book
                        id="m53ynos09g"
                        image="https://m.media-amazon.com/images/I/71HbYElfY0L._AC_UF1000,1000_QL80_.jpg"
